...
class CascadeRCNNFrozen(BaseDetector, RPNTestMixin):
    ...
    def __init__(self,
        ...
        super(CascadeRCNNFrozen, self).__init__()
    ...
    def init_weights(self, pretrained=None):
        super(CascadeRCNNFrozen, self).init_weights(pretrained)
    ...
    def show_result(self, data, result, **kwargs):
        ...
        super(CascadeRCNNFrozen, self).show_result(data, result, **kwargs)
